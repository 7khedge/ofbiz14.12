...
<xsl:param name="VersionFileURL">$URL: https://svn.apache.org/repos/asf/ofbiz/branches/release14.12/specialpurpose/cmssite/template/docbook/VERSION.xsl $</xsl:param>
