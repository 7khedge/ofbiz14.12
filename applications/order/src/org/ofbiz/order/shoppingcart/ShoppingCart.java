 ...
 */
@SuppressWarnings({"serial", "WhileLoopReplaceableByForEach"})
...
//    protected String billFromVendorPartyId = null;
  //  protected String shipFromVendorPartyId = null;
    ...
    public void cleanUpShipGroups() {
        // REFACTOR to use Collection.removeIf instead of loop and also remove potential concurrency issue with shipInfo.remove()
